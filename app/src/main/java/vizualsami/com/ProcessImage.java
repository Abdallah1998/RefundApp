...
import static vizualsami.com.utils.CommonUtils.APP_PATH;
import static vizualsami.com.utils.CommonUtils.TAG;
import static vizualsami.com.utils.CommonUtils.info;
...
import vizualsami.com.utils.CharDetectOCR;
...
public class ProcessImage {
    ...
    public boolean parseBitmap(Bitmap bitmap, int top, int bot, int right, int left) {
        try {
            ...
            // Crop image to get the region inside the rectangle only
